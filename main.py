    ...
    with socket.socket(socket.AF_INET, socket.SOCK_STREAM) as s:
        ...
        while True:
            ...
            with conn:
                ...
                print(f"{round(tracking_data['accuracy'], 4)}")

                UI.update_clusters(tracking_data['tracking'], tracking_data['tracked_point'], tracking_data['prediction'], tracking_data['clusters'], tracking_data['override'])
